...
#define DEV_SCREEN 7
#define DEV_SCREEN_HTML "Development:<br/>Image Base:$%08x<br/>-Dump Memory-<br/><form action=\"e:e\">Start Address (Hex):<input name=\"start_addr\"></input><br/>Length (Hex):<input name=\"length\"></input><input type=\"submit\" value=\"SET\"></input></form><br/><a href=\"-8\">Dump to fs:/~/</a><br/><a href=\"-11\">Dump to fs:/card0/</a><br/>Registers!<br/>R13(SP):$%08x<br/>CPSR:$%08x;%s<br/><a href=\"6\">Back</a><br/><a href=\"8\">Next</a>",image_base_address_ram,_r13,_cpsr,describe_cpsr()
